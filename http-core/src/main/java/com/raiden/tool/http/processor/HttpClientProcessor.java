...
public interface HttpClientProcessor {
     ...
     * @param requestEnum 请求类型 json form file {@link RequestEnum}
     * @param url 请求地址
     ...
     */
    Object handler(HttpMethod method, Map<String, String> headMap, Class<?> returnType, Type typeArgument, RequestEnum requestEnum,
